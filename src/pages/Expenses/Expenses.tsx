            ...
            <div className={styles.expensesCard}>
                <section className={styles.expensesOverview}>
                    <div className={styles.expensesHeader}>
                        ...
                        <div className={styles.expensesActions}>
                            <div className={styles.personImages}>
                                <img src={personOne} className={styles.personOne} />
                                <img src={personTwo} className={styles.personTwo} />
                                <img src={personThree} className={styles.personThree} />
                            </div>
                            <button>
                        ...
                        <BarChart data={data}>
                            <Bar dataKey="uv" fill="rgba(21, 122, 255, .2)" onMouseOver={onMouseOver}>
                                {data.map((entry, index) => 
                                    <Cell cursor="pointer" fill={index === activeIndex ? "rgb(21, 122, 255)" : "rgba(21, 122, 255, .2)"} key={index} />
                                )}
                            </Bar>
                        </BarChart>
                    </ResponsiveContainer>
                    <div className={styles.expensesOverviewHeader}>
                        ...
                        <button>
                            <img src={optionIcon} className={styles.expenseOption} />
                        </button>
                    </div>
                    <ul>
                        ...
                        <li className={styles.expenseItem} key={expense.id}>
                            <div className={styles.expenseItemLeft}>
                                <div className={styles.expenseItemDiv} style={{ backgroundColor: expense.iconBackgroundColor }}>
                    ...
                    <div className={styles.expensesOverviewHeader}>
                        <p className={styles.expensesOverviewTitle}>Tuesday, 01 February 2022</p>
                        <button>
                            <img src={optionIcon} className={styles.expenseOption} />
                        </button>
                    </div>
                ...
                <section className={styles.moneyOverview}>
                        ...
                        <li key={category.id}>
                          ...
                          <div className={styles.spendCategoryBar}>
                              <div className={styles.spendCategoryColorBar} 
                                   style={{width: `${(category.price / spendCategories.reduce((acc, current) => acc + current.price, 0)) * 100}%`}}>
                              </div>
                          </div>
                        </li> 
                      ))}                        
                    ...
                    <div className={styles.saveMoneyDiv}>
                      ...
                      <button type="button" className={styles.button}>VIEW TIPS</button>
                    </div>
